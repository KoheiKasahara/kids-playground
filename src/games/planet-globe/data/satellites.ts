...
export const satellites: readonly SatelliteSpec[] = [
  ...
  { id: 'charon', displayName: 'カロン', spokenName: 'カロン', parentBodyId: 'pluto', displayScale: 0.48, orbitRadius: 57, orbitSpeed: 0.18, initialAngle: 0.2, appearance: rocky('#85827d', '#b7b0a7', '#424140'), description: 'めいおうせいの およそ はんぶんの おおきさだよ。めいおうせいと ふたりで きょうつうの おもりの まわりを まわるよ。', hitRadiusPx: 44, shapeScale: { x: 1.08, y: 0.98, z: 1.02 }, orbitInclination: 0.03, barycenter: { parentOffsetRatio: 0.18, satelliteOffsetRatio: 0.82 } },
]
