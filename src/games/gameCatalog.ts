...
export const GAME_CATALOG: readonly GameCatalogEntry[] = [
  ...
  },
  {
    ...
    seo: {
      ...
      description: '指で描いた線が動かない道や橋になり、ボールを大きなゴールへ導く幼児向け物理パズルです。縦画面の6ステージで、坂・橋・段差・はずむ床を楽しめます。何度でも描き直せます。',
    },
    intro: {
      howToPlay: ['ステージを えらんで、せんで みちを かこう', 'せんは なんぼんでも かけるよ。スタートで ボールが コロコロ！', 'ゴールに はいったら クリア。なんどでも やりなおせるよ'],
    },
  },
]
