...
export const GAME_CATALOG: readonly GameCatalogEntry[] = [
  ...
  },
  {
    ...
    emoji: '🚙',
    seo: {
      headline: '3Dクルマづくり｜自分だけの車をつくって走らせる',
      description:
        'ボディ・タイヤ・カラー・やねなど8つのカテゴリをえらんで、3Dのくるまを自由につくれるあそびです。えらんだしゅんかんに見た目が変わり、指でまわして見られます。できあがったら、かんらんしゃがならぶコースでその車を走らせられます。',
    },
    category: 'threeD',
    intro: {
      howToPlay: [
  ...
  },
  {
    ...
    emoji: '🖍️',
    seo: {
      headline: 'うごくぬりえ｜でんしゃ・ひこうき・ショベルカーなど22のぬりえ',
      description:
        'くるま・でんしゃ・ショベルカー・ききゅう・ペンギンなど22の絵から題材をえらび、色をえらんでタップするだけで塗れる幼児向けのぬりえです。線からはみ出す心配がないので、はじめてのぬりえにも向いています。',
    },
    category: 'learning',
    intro: {
      howToPlay: [
  ...
  },
  {
    ...
    emoji: '🧩',
    seo: {
      headline: 'ブロックパズル｜すきな形をならべる・おちてくるブロックをつむ',
      description:
        'すきな形を自由にならべるモードと、おちてくるブロックをつむモードがえらべる幼児向けパズルです。おちてくるほうは置きたい場所をタップでえらんでからおとせて、おちるはやさも変えられます。',
    },
    category: 'learning',
    intro: {
      howToPlay: [
        'はじめに 2つの あそびかたを えらぶよ',
        'じゆうに ならべるは すきな ところに おけるよ',
        'おちてくるは ばしょを えらんで おとせるよ',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    category: 'threeD',
    seo: {
      headline: 'でんしゃの たび｜橋・トンネル・都会を走る3D電車あそび',
      description: '新幹線・機関車・貨物列車で立体的な線路を走る幼児向け3Dゲーム。島のコースは橋・森のトンネル・ふみきりの街へ。都会のコースは2つのポイントで、高架・地下鉄・川ぞいと、タワー・観覧車の港を切り替えられます。',
    },
    intro: {
      howToPlay: [
        'しまか とかいの コースと、すきな でんしゃを えらんで「しゅっぱつ！」',
        '「ポイント」で、せんろを きりかえよう。とかいは ポイントが ふたつ！',
  ...
  },
  {
    ...
    seo: {
      ...
      description: 'はらっぱ・うみべ・もり・くだりざかなど8つのコースを回る幼児向けの3Dパターゴルフ。木をよけて進むとても広い森や、坂と段差で高台からおりるホールもあり、ひっぱって はなすとボールが物理演算のとおりに転がります。',
    },
    intro: {
      howToPlay: [
  ...
  },
  {
    ...
    category: 'learning',
    seo: {
      headline: 'しんけいすいじゃく｜4つの絵柄からえらんでカードをめくる記憶あそび',
      description:
        'どうぶつ・はたらくくるま・すうじ・こっきの4つの絵柄からえらび、カードを2まいずつめくって同じ絵のペアをさがす幼児向けの記憶あそびです。かんたん・むずかしいの2つのむずかしさから選べ、何度でも遊べます。',
    },
    intro: {
      howToPlay: [
        'えがらを えらんで、カードを 2まい めくろう',
  ...
  },
  {
    ...
    seo: {
      ...
      description:
        '夜空の星を1・2・3…と数字の順に指でつなぐと、さかな・きょうりゅう・おしろなどの星座が完成して動き出す幼児向けの点つなぎあそびです。3つのむずかしさから選べ、数の順番を楽しくおぼえられます。',
    },
    intro: {
      howToPlay: [
        '1の ほしから じゅんばんに つないでね',
        'ゆびで なぞっても、タップしても つながるよ',
        'さいごまで つなぐと せいざが うごきだすよ',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    seo: {
      ...
      description:
        'むかしの ゲーム機の ような ドット絵で えがいた もり・ゆうやけの はまべ・よるの いせき・ゆきのはらを あるいて、ほしの かけらを あつめる 子ども向けの ぼうけんゲーム。スライムや カニ・ペンギンを なかまに して、たからばこを さがそう。',
    },
    intro: {
      howToPlay: [
  ...
  },
  {
    ...
    intro: {
      howToPlay: [
        'おきたい ところを さわろう。ながおし して ずらすと ねらえるよ',
        'さっと ずらすと まわるよ。ふたゆびで ちかく・とおく',
