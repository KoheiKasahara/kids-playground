...
export const GAME_CATALOG: readonly GameCatalogEntry[] = [
  ...
  },
  {
    ...
    category: 'threeD',
    seo: {
      headline: 'でんしゃの たび｜橋・トンネル・街を走る3D電車あそび',
      description: '新幹線・機関車・貨物列車を選んで、立体的な線路を自動で走る様子を楽しむ幼児向け3Dゲームです。ポイントを切り替えると、高架の橋、森のトンネル、ふみきりのあるビルの街へ。駅でひとやすみしたり、加速や汽笛で自由に遊べます。',
    },
    intro: {
      howToPlay: [
        'すきな でんしゃを えらんで「しゅっぱつ！」',
        '「ポイント」で、はし・トンネル・まちを きりかえよう',
