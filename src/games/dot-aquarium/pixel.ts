...
// 乱数・ノイズ・ディザ（ベイヤー行列）・色の へんかん・canvas の よういを まとめる。
// ここは DOM を ほとんど さわらない 計算だけにして、テストや シミュレーションから つかえるように する。
...
export function unpack(p: number): [number, number, number, number] {
