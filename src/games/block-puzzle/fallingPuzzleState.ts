...
/**
 * 落ちてくるモードの盤面の列数・行数。
 * 自由に置くモード（6×8）より1列少ない5列にしているのは、
 * よこ1れつ をそろえるのに必要なマスが減り、幼児でも「そろった！」に届きやすいから。
 * 縦は、上から落ちてくる様子が分かり、かつ1マスが小さくなりすぎない9段にしている。
 */
export const FALLING_COLS = 5
export const FALLING_ROWS = 9
