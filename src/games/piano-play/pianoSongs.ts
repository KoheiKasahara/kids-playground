...
/**
 * パブリックドメインの旋律を、このアプリのC4〜E5鍵盤向けに独自に単旋律化した曲データ。
...
export const PIANO_SONGS: readonly PianoSong[] = [
  ...
  defineSong({
    ...
    title: 'ゆかいな牧場',
    tempoBpm: 108,
    // 主音をC5に置き、低いソと高いミをオクターブで折り返さず再生する。
    steps: [
      ['C5', 1], ['C5', 1], ['C5', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2],
      ['E5', 1], ['E5', 1], ['D5', 1], ['D5', 1], ['C5', 2],
      ['G4', 0.5], ['G4', 0.5], ['C5', 1], ['C5', 1], ['C5', 1],
      ['G4', 0.5], ['G4', 0.5], ['C5', 1], ['C5', 1], ['C5', 2],
      ['C5', 0.5], ['C5', 0.5], ['C5', 1], ['C5', 0.5], ['C5', 0.5], ['C5', 1],
      ['C5', 0.5], ['C5', 0.5], ['C5', 0.5], ['C5', 0.5], ['C5', 1], ['C5', 1],
      ['C5', 1], ['C5', 1], ['C5', 1], ['G4', 1], ['A4', 1], ['A4', 1], ['G4', 2],
      ['E5', 1], ['E5', 1], ['D5', 1], ['D5', 1], ['C5', 2],
    ],
  }),
