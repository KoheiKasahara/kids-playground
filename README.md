...
│  ├─ working-vehicle-quiz/ # はたらくくるまクイズ（11車両・2モード）
...
├─ images/
│  ├─ working-vehicles/ # はたらくくるまイラスト（PNG、11枚）
